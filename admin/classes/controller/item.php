...
* @subpackage	
*/
class GeoeventsCkClassControllerItem extends JControllerForm
{
	/**
	...
	* @var string
	*/
	protected $text_prefix = 'COM_GEOEVENTS';
	...
	*/
	public function add()
	{
		...
		$this->applyRedirection($result, array(
			'com_geoevents.' . $this->view_list . '.default',
			'com_geoevents.' . $this->view_item . '.' . $this->getLayout('edit')
		));
	}
	...
	*/
	public function delete()
	{
		...
		else
		{
			...
			{
				$result = true;
				$this->setMessage(JText::plural('GEOEVENTS_ITEMS_SUCCESSFULLY_DELETED', count($cid)));
			}
			else
			{
...
JLoader::register('GeoeventsClassControllerItem', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'classes' .DS. 'controller' .DS. 'item.php');
JLoader::load('GeoeventsClassControllerItem'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('GeoeventsClassControllerItem')){ class GeoeventsClassControllerItem extends GeoeventsCkClassControllerItem{} }
