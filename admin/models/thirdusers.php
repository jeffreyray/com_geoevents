...
* @subpackage	Classes
*/
class GeoeventsCkModelThirdusers extends GeoeventsClassModelList
{
	/**
...
JLoader::register('GeoeventsModelThirdusers', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'models' .DS. 'thirdusers.php');
JLoader::load('GeoeventsModelThirdusers'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('GeoeventsModelThirdusers')){ class GeoeventsModelThirdusers extends GeoeventsCkModelThirdusers{} }
