...
* @subpackage	Form
*/
class GeoeventsCkFormFieldCksort extends GeoeventsClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCksort', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'cksort.php');
JLoader::load('JFormFieldCksort'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('JFormFieldCksort')){ class JFormFieldCksort extends GeoeventsCkFormFieldCksort{} }
