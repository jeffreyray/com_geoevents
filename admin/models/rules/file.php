...
* @subpackage	Form
*/
class GeoeventsCkFormRuleFile extends GeoeventsClassFormRule
{
	/**
	...
	*/
	public function getJsonRule($fieldNode)
	{
		...
		if (isset($fieldNode['msg-incorrect']))
			...
			$values["alertText"] = LI_PREFIX . JText::sprintf('GEOEVENTS_ERROR_ALLOWED_FILES', $allowedExtensionsText);
...
JLoader::register('JFormRuleFile', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'models' .DS. 'rules' .DS. 'file.php');
JLoader::load('JFormRuleFile'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('JFormRuleFile')){ class JFormRuleFile extends GeoeventsCkFormRuleFile{} }
