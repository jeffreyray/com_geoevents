...
* @subpackage	Form
*/
class GeoeventsCkFormRuleDefault extends GeoeventsClassFormRule
{
	/**
...
JLoader::register('JFormRuleDefault', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'models' .DS. 'rules' .DS. 'default.php');
JLoader::load('JFormRuleDefault'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('JFormRuleDefault')){ class JFormRuleDefault extends GeoeventsCkFormRuleDefault{} }
