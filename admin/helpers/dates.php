...
JLoader::register('GeoeventsHelperDates', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'helpers' .DS. 'dates.php');
JLoader::load('GeoeventsHelperDates'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('GeoeventsHelperDates')){ class GeoeventsHelperDates extends GeoeventsCkHelperDates{} }
