...
* @subpackage	Form
*/
class GeoeventsCkFormFieldCkradio extends GeoeventsClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCkradio', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'ckradio.php');
JLoader::load('JFormFieldCkradio'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('JFormFieldCkradio')){ class JFormFieldCkradio extends GeoeventsCkFormFieldCkradio{} }
