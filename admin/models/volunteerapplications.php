...
* @subpackage	Classes
*/
class GeoeventsCkModelVolunteerapplications extends GeoeventsClassModelList
{
	/**
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		{
			case 'volunteerapplications.modal':
				break;
			case 'all':
...
JLoader::register('GeoeventsModelVolunteerapplications', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'models' .DS. 'volunteerapplications.php');
JLoader::load('GeoeventsModelVolunteerapplications'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('GeoeventsModelVolunteerapplications')){ class GeoeventsModelVolunteerapplications extends GeoeventsCkModelVolunteerapplications{} }
