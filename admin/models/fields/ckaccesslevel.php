...
* @subpackage	Form
*/
class GeoeventsCkFormFieldCkaccesslevel extends GeoeventsClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCkaccesslevel', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'ckaccesslevel.php');
JLoader::load('JFormFieldCkaccesslevel'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('JFormFieldCkaccesslevel')){ class JFormFieldCkaccesslevel extends GeoeventsCkFormFieldCkaccesslevel{} }
