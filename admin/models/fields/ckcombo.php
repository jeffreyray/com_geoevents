...
* @subpackage	Form
*/
class GeoeventsCkFormFieldCkcombo extends GeoeventsClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCkcombo', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'ckcombo.php');
JLoader::load('JFormFieldCkcombo'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('JFormFieldCkcombo')){ class JFormFieldCkcombo extends GeoeventsCkFormFieldCkcombo{} }
