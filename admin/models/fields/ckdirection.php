...
* @subpackage	Form
*/
class GeoeventsCkFormFieldCkdirection extends GeoeventsClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCkdirection', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'ckdirection.php');
JLoader::load('JFormFieldCkdirection'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('JFormFieldCkdirection')){ class JFormFieldCkdirection extends GeoeventsCkFormFieldCkdirection{} }
