...
* @subpackage	Classes
*/
class GeoeventsCkModelThirdviewlevels extends GeoeventsClassModelList
{
	/**
...
JLoader::register('GeoeventsModelThirdviewlevels', JPATH_ADMIN_GEOEVENTS .DS. 'fork' .DS. 'models' .DS. 'thirdviewlevels.php');
JLoader::load('GeoeventsModelThirdviewlevels'); /* To load class in memory */
// Fallback if no fork has been found
if (!class_exists('GeoeventsModelThirdviewlevels')){ class GeoeventsModelThirdviewlevels extends GeoeventsCkModelThirdviewlevels{} }
